...
/*   Updated: 2021/04/22 03:34:04 by mdereuse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Path {
	...
	public:
		...
		static bool is_escaped_char(const std::string &path, size_t index);
		static bool is_unreserved_char(const char c);
		static bool is_reserved_path_char(const char c);
		static bool is_reserved_query_char(const char c);
		static bool is_reserved_user_info_char(const char c);
		static bool is_reserved_reg_name_char(const char c);
		static bool is_uri_no_slash_char(const std::string &path, size_t index);
